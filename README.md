...
本文件旨在帮助新入门的开发者在环境配置、代码调试以及日常系统使用过程中，能更快速地定位与解决问题。  
...
**查找问题前先检索：** 优先通过关键词搜索已有记录，避免重复排查。  

**按格式追加新记录：** 遇到新问题时，请按照“问题 / 原因 / 解决办法”的结构补充，确保条理统一、便于他人理解。  

**记录关键版本信息：** 每次问题描述中请尽量注明系统环境、Python 和库版本号，这对后续复现非常重要。  

**验证后再更新：** 确认有效的解决方案再提交到文档中，保持内容质量和可参考性。  
...
**新增记录请先在 Readme 中编辑，再补充进在线协作文档中**

## 📎 在线协作文档
点击下面的链接打开并在线编辑：
[打开协作版 Debug 指南（Word Online）](https://1drv.ms/w/c/60a61e70dafb388a/EafhDLNvolpEspWKXFtPHFgByXNL_YA6qH8Qxfdxvb2Egw?e=0ppIhb)
...
## Debug记录 1：证书报错（pip 安装包时 SSL 认证失败）
